...
import HeroImage from './hero@1x.png'
...
const TopPolygon = () => {
    return (
        <div
            className='w-full absolute top-0 bottom-auto left-0 right-0'
        >
            <svg
            ...
            >
                <polygon
                    ...
                    points='0,0 2560,0 2560,0 0,100'
                ></polygon>
            </svg>
        </div>
    )
    ...
    return (
        <div className='relative h-screen bg-slate-100'>
            <div className='md:flex md:items-center h-full'>
                <div className='container w-full h-full md:w-3/5 mx-auto'>
                    <div className='text-black text-center rounded-xl px-16 py-16 mt-40'>
                        ...
                        <div
                            className='w-full p-16 bg-center bg-no-repeat bg-cover mt-16'
                            style={{
                                backgroundImage: `url(${HeroImage.src})`
                            }}
                        >
                            <div className='w-4/5 my-8 px-8 py-4 mx-auto bg-amber-400 bg-opacity-40'>
